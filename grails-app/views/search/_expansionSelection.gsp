				...
				<uib-tabset active="active">
    				<uib-tab ng-repeat="embedding in ctrl.embeddings track by $index" index="$index" heading="{{ctrl.currentSearch.inputExpansion.targetLabel(embedding.word)}}">
						...
						<div class="row">
							<div class="col-md-3">
								<ul>
                					<li ng-repeat="suggestion in ctrl.embeddings[$index].relatedMisspellings | limitTo:8:0" style="list-style-type:none">
                    					<input ng-click="ctrl.currentSearch.inputExpansion.add(embedding.word, suggestion.term)" type="checkbox">
										{{ suggestion.term }} 
										</input>
							...
							<div class="col-md-3">
								<ul>
                					<li ng-repeat="suggestion in ctrl.embeddings[$index].relatedMisspellings | limitTo:8:8" style="list-style-type:none">
                    					<input ng-click="ctrl.currentSearch.inputExpansion.add(embedding.word, suggestion.term)" type="checkbox">
										{{ suggestion.term }} 
										</input>
										<small style="color:gray"><i>{{suggestion.frequency | number }} | {{suggestion.score | number:2 }} | {{suggestion.edit_distance}}</i></small>
							...
							<div class="col-md-3">
								<ul>
                					<li ng-repeat="suggestion in ctrl.embeddings[$index].relatedMisspellings | limitTo:8:16" style="list-style-type:none">
                    					<input ng-click="ctrl.currentSearch.inputExpansion.add(embedding.word, suggestion.term)" type="checkbox">
										{{ suggestion.term }} 
										</input>
										<small style="color:gray"><i>{{suggestion.frequency | number }} | {{suggestion.score | number:2 }} | {{suggestion.edit_distance}}</i></small>
							...
							<div class="col-md-3">
								<ul>
                					<li ng-repeat="suggestion in ctrl.embeddings[$index].relatedMisspellings | limitTo:8:24" style="list-style-type:none">
                    					<input ng-click="ctrl.currentSearch.inputExpansion.add(embedding.word, suggestion.term)" type="checkbox">
										{{ suggestion.term }} 
										</input>
										<small style="color:gray"><i>{{suggestion.frequency | number }} | {{suggestion.score | number:2 }} | {{suggestion.edit_distance}}</i></small>
						...
						<div class="row">
							<div class="col-md-3">
								<ul>
                					<li ng-repeat="suggestion in ctrl.embeddings[$index].semanticallyRelatedTerms | limitTo:15:0" style="list-style-type:none">
										<input ng-click="ctrl.currentSearch.inputExpansion.add(embedding.word, suggestion.term)" type="checkbox">
										{{ suggestion.term }}
										</input>
							...
							<div class="col-md-3">
								<ul>
                					<li ng-repeat="suggestion in ctrl.embeddings[$index].semanticallyRelatedTerms | limitTo:15:15" style="list-style-type:none">
                    					<input ng-click="ctrl.currentSearch.inputExpansion.add(embedding.word, suggestion.term)" type="checkbox">
										{{ suggestion.term }}
										</input>
										<small style="color:gray"><i>{{ suggestion.frequency | number }} | {{ suggestion.cosine_distance | number :2 }}</i></small>
							...
							<div class="col-md-3">
								<ul>
                					<li ng-repeat="suggestion in ctrl.embeddings[$index].semanticallyRelatedTerms | limitTo:15:30" style="list-style-type:none">
                    					<input ng-click="ctrl.currentSearch.inputExpansion.add(embedding.word, suggestion.term)" type="checkbox">
										{{ suggestion.term }}
										</input>
										<small style="color:gray"><i>{{ suggestion.frequency | number }} | {{ suggestion.cosine_distance | number :2 }}</i></small>
							...
							<div class="col-md-3">
								<ul>
                					<li ng-repeat="suggestion in ctrl.embeddings[$index].semanticallyRelatedTerms | limitTo:15:45" style="list-style-type:none">
                    					<input ng-click="ctrl.currentSearch.inputExpansion.add(embedding.word, suggestion.term)" type="checkbox">
										{{ suggestion.term }}
										</input>
										<small style="color:gray"><i>{{ suggestion.frequency | number }} | {{ suggestion.cosine_distance | number :2 }}</i></small>
