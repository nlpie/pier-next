	...
	<body>
		...
		<div class="container-fluid" ng-controller="resultsController as rc">
			<div ng-repeat="corpus in rc.search.context.candidateCorpora track by $index">
				<div class="row main">
					<div class="col-xs-3">
						<div ng-if="rc.search.status.computingAggs" id="aggs-spinner" class="pull-left" style="padding-top:25px">
							<asset:image src="ajax-loader.gif" alt="Loading..." /> computing filters...
						</div>
						<div ng-if="rc.search.results[corpus.name].aggs" ng-repeat="(category, categoryItems) in corpus.queryFilters track by $index">
					...
					<div class="col-xs-9">
						<div ng-if="rc.search.status.searchingDocs" id="docs-spinner" class="pull-left" style="padding-top:25px">
