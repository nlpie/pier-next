...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		Cluster.withSession { session ->
			...
			def noteType = Type.findByTypeName("note")?:new Type(typeName:"note", description:"CDR note", environment:Environment.current.toString(), corpusType:clinicalCorpusType)
			...
			def surgPathType = Type.findByTypeName("report")?:new Type(typeName:"report", description:"CDR surgical path report", environment:Environment.current.toString(), corpusType:surgPathCorpusType)
