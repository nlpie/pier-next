...
class HelpController {
	...
	$onInit() {
		...
		let queries= [
		              ...
		              {query: 'pat_mrn:xxxxxxxxxxx', name:"mrn search", explanation:"Restrict results to the specified MRN. Can be used in combination with other terms, e.g., keywords and/or service_date(s)"},
		              {query: 'service_date:[2012-01-01 TO 2012-12-31]', name:"range searches", explanation:"Restrict results to those with a service date within a range. Wildcards can be used as upper or lower bounds, e.g., service_date:[* TO 2012-12-31]. Single service date values are also permitted, e.g., service_date:2012-06-02"},
