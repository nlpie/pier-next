...
class PierNoteSetContextByUser extends AbstractPierContext implements AuthorizedPierContext {
	
	static mapping = {
		datasource 'notes'
		//table name: "unioned_auth_contexts_by_user", schema: "notes"	//view in notes schema
		table name: "pier_note_set_context_by_user", schema: "notes"	//view in notes schema
